...
# track wants to accept more formats than default, here they are
input_formats = [
...
def dashboard(request):
    ...
    # If the start_date is before track began, warn about incomplete data
    ...
    return render(request, 'track/dashboard.html', context)
